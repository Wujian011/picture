...
public abstract class PictureUploadTemplate {
    ...
    public UploadPictureResult uploadPicture(Object inputSource, String uploadPathPrefix) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(objectList)) {
                ...
                // 缩略图 默认等于压缩图
                CIObject tumbnailCiObject = compressedCiObject;
                // 生成缩略图，才得到缩略图
                if (objectList.size() > 1) {
                    tumbnailCiObject = objectList.get(1);
                }
                // 封装压缩图的返回结果
                return buildResult(originalFilename, compressedCiObject, tumbnailCiObject);
            }
     ...
     * @return
     */
    private UploadPictureResult buildResult(String originalFilename, CIObject compressedCiObject, CIObject tumbnailCiObject) {
        ...
        // 设置图略图+
        uploadPictureResult.setThumbnailUrl(cosClientConfig.getHost() + "/" + tumbnailCiObject.getKey());
